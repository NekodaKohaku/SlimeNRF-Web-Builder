const I18N = {
  zh: {
    ...
    ledCh:"LED 種類", ledCh1:"單色", ledCh2:"雙色", ledCh3:"RGB 三色", ledCh4:"可定址 LED", helpLedCh:"LED 種類。單色＝1 支腳；雙色/RGB＝2~3 支 PWM 腳(共陽/共陰皆可,極性沿用上面設定);可定址 LED＝相容於 NeoPixel 協議的 LED。如 WS2812, 只吃 1 支 data 腳。",
  ...
  en: {
    ...
    ledCh:"LED type", ledCh1:"Single", ledCh2:"Dual", ledCh3:"RGB (tri)", ledCh4:"Addressable", helpLedCh:"LED type. Single = 1 pin; Dual/RGB = 2-3 PWM pins (common anode/cathode, shares the polarity above); Addressable = a NeoPixel-protocol LED, e.g. WS2812, 1 data pin only.",
  ...
  ja: {
    ...
    ledCh:"LED 種類", ledCh1:"単色", ledCh2:"2色", ledCh3:"RGB（3色）", ledCh4:"アドレサブル", helpLedCh:"LED 種類。単色＝1本;2色/RGB＝PWM 2〜3本(アノード/カソード共通、極性は上を共用);アドレサブル＝NeoPixel プロトコル互換の LED(例:WS2812)、data 1本のみ。",
